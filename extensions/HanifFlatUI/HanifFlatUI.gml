...
if(ds_exists(ui_global_controls, ds_type_list)){
  ...
  for(var ui_i = 0; ui_i < ds_list_size(ui_global_controls); ui_i += 1){
    var control = ds_list_find_value(ui_global_controls, ui_i);
    if(ds_exists(control, ds_type_map)){
      if(ui_get_type(control) == ui_type_select){ui_select_draw(control);}
    }
    if(ds_exists(control, ds_type_map)){
      if(ui_get_type(control) == ui_type_sidenav){ui_sidenav_draw(control);}
    }
  }
...
if(argument_count == 1){
  ...
  if(ds_exists(ui_global_config, ds_type_map)){
    if(ds_map_find_value(ui_global_config, "debug_mode")){
      show_debug_message(ui_text_message);
      return true;
    }
  }
...
if(argument_count == 5){
  ...
  var ui_width = max(argument[2] - 32, ui_default);
  var ui_height = max(argument[3] - 16, ui_default);
  ...
  ds_map_add(ui_control, "ui_padding_horizontal", 16);
  ds_map_add(ui_control, "ui_padding_vertical", 8);
...
if(argument_count == 5){
  ...
  var ui_control = ds_map_create();
  var ui_width = max(argument[2] - 0, ui_default);
  var ui_height = max(argument[3] - 12, ui_default);
  ...
  ds_map_add(ui_control, "ui_padding_vertical", 6);
  ds_map_add(ui_control, "ui_effect", ui_effect);
  ds_map_add(ui_control, "ui_effect_speed", ui_effect_speed);
  ds_map_add(ui_control, "ui_shadow", ui_shadow);
  if(ds_exists(ui_global_controls, ds_type_list)){ds_list_add(ui_global_controls, ui_control);}
...
if(argument_count == 1){
  if(ds_exists(argument[0], ds_type_map)){
    ...
    if(ui_enable){
      ...
      if(ui_password){
        var ui_password_length = string_length(ui_alias_text);
        if(string_length(ui_alias_text) > floor(ui_width / 12)){i_password_length = floor(ui_width / 12);}
...
if(argument_count == 4){
  ...
  var ui_control = ds_map_create();
  var ui_size = max(argument[2] - 16, ui_default);
...
if(argument_count == 1){
  if(ds_exists(argument[0], ds_type_map)){  
    ...
    var ui_shadow = ds_map_find_value(argument[0], "ui_shadow");
    if(ui_size == ui_default) ui_size = 20;
    if(ui_inner_colour == ui_default) ui_inner_colour = surface_getpixel(application_surface, ui_x + (ui_size * 0.5), ui_y + (ui_size * 0.5));
    if(font_exists(ui_label_font)) draw_set_font(ui_label_font);
    if(ui_enable){
      ...
      if(ui_active && ((ui_mouse_x > ui_x && ui_mouse_x < ui_x + ui_size && ui_mouse_y > ui_y && ui_mouse_y < ui_y + ui_size) or (ui_mouse_x > ui_x + ui_size && ui_mouse_x < ui_x + ui_size + ui_padding_horizontal + string_width(ui_label) && ui_mouse_y > ui_y + ((ui_size * 0.5) - (string_height(ui_label) * 0.5))&& ui_mouse_y < ui_y + ((ui_size * 0.5) + (string_height(ui_label) * 0.5))) or (ui_focus && keyboard_action && keyboard_check_pressed(vk_enter)))){
      ...
      if(ui_shadow){
        ...
        draw_rectangle_colour(ui_x - 1, ui_y - 1, ui_x + ui_size + 1, ui_y + ui_size + 1, ui_black, ui_black, ui_black, ui_black, false);
        draw_rectangle_colour(ui_x - 1, ui_y - 1, ui_x + ui_size + 1, ui_y + ui_size + 2, ui_black, ui_black, ui_black, ui_black, false);
        draw_set_alpha(1);
      }      
      draw_rectangle_colour(ui_x, ui_y, ui_x + ui_size, ui_y + ui_size, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, false);
      draw_rectangle_colour(ui_x + 2, ui_y + 2, ui_x + ui_size - 2, ui_y + ui_size - 2, ui_inner_colour, ui_inner_colour, ui_inner_colour, ui_inner_colour, false);
      if(ui_checked or ui_alpha > 0){
        draw_set_alpha(ui_alpha);
        draw_rectangle_colour(ui_x, ui_y, ui_x + ui_size, ui_y + ui_size, ui_background_colour, ui_background_colour, ui_background_colour, ui_background_colour, false);
        draw_line_width_colour(ui_x + (ui_size * 0.5) - (min(ui_size, 20) / 2.66), ui_y + (ui_size * 0.5) - (min(ui_size, 20) / 16), ui_x + (ui_size * 0.5) - (min(ui_size, 20) / 8), ui_y + (ui_size * 0.5) + (min(ui_size, 20) / 5.33), round(min(ui_size / 8, 3)), ui_inner_colour, ui_inner_colour);
        draw_line_width_colour(ui_x + (ui_size * 0.5) - (min(ui_size, 20) / 8), ui_y + (ui_size * 0.5) + (min(ui_size, 20) / 5.33), ui_x + (ui_size * 0.5) + ((min(ui_size, 20) / 3.2) * ui_alpha), ui_y + (ui_size * 0.5) - ((min(ui_size, 20) / 4) * ui_alpha), round(min(ui_size / 8, 3)), ui_inner_colour, ui_inner_colour);
        draw_set_alpha(1);
      }
      draw_set_halign(fa_left);
      draw_set_valign(fa_middle);
      if(ui_shadow) draw_text_colour(ui_x + ui_size + ui_padding_horizontal, ui_y +(ui_size * 0.5) + 1, ui_label, ui_black, ui_black, ui_black, ui_black, 0.05);
      draw_text_colour(ui_x + ui_size + ui_padding_horizontal, ui_y +(ui_size * 0.5), ui_label, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
      draw_set_halign(fa_left);
      draw_set_valign(fa_top);
    }
    else{
      draw_roundrect_colour_ext(ui_x, ui_y, ui_x + ui_size, ui_y + ui_size, 4, 4, ui_colour_lighter_ext(ui_grey, 2), ui_colour_lighter_ext(ui_grey, 2), false);
      if(ui_checked){
        draw_line_width_colour(ui_x + (ui_size * 0.5) - (min(ui_size, 20) / 2.66), ui_y + (ui_size * 0.5) - (min(ui_size, 20) / 16), ui_x + (ui_size * 0.5) - (min(ui_size, 20) / 8), ui_y + (ui_size * 0.5) + (min(ui_size, 20) / 5.33), round(min(ui_size / 8, 3)), ui_inner_colour, ui_inner_colour);
        draw_line_width_colour(ui_x + (ui_size * 0.5) - (min(ui_size, 20) / 8), ui_y + (ui_size * 0.5) + (min(ui_size, 20) / 5.33), ui_x + (ui_size * 0.5) + (min(ui_size, 20) / 3.2), ui_y + (ui_size * 0.5) - (min(ui_size, 20) / 4), round(min(ui_size / 8, 3)), ui_inner_colour, ui_inner_colour);
      }
      draw_set_halign(fa_left);
      draw_set_valign(fa_middle);
      draw_text_colour(ui_x + ui_size + ui_padding_horizontal, ui_y +(ui_size * 0.5), ui_label, ui_grey, ui_grey, ui_grey, ui_grey, 1);
      draw_set_halign(fa_left);
      draw_set_valign(fa_top); 
    }
    if(ui_focus){
      if(ds_exists(ui_global_config, ds_type_map)){
        if(ds_map_find_value(ui_global_config, "debug_mode")){
          draw_set_alpha(0.25);
          draw_rectangle_colour(ui_x - 1, ui_y - 1, ui_x + ui_size + ui_padding_horizontal + string_width(ui_label) + 2, ui_y + ui_size + 2, ui_blue_grey, ui_blue_grey, ui_blue_grey, ui_blue_grey, true);
          draw_set_alpha(1);
        }
      }
    }
...
if(argument_count == 1){
  if(ds_exists(argument[0], ds_type_map)){  
    ...
    if(ui_enable){
      ...
      if(ui_active && ((ui_mouse_x > ui_x && ui_mouse_x < ui_x + ui_size && ui_mouse_y > ui_y && ui_mouse_y < ui_y + ui_size) or (ui_mouse_x > ui_x + ui_size && ui_mouse_x < ui_x + ui_size + ui_padding_horizontal + string_width(ui_label) && ui_mouse_y > ui_y + ((ui_size * 0.5) - (string_height(ui_label) * 0.5))&& ui_mouse_y < ui_y + ((ui_size * 0.5) + (string_height(ui_label) * 0.5))))){
        ui_shadow_alpha = 0.02;
        if(device_mouse_check_button_pressed(0, mb_left)){
          if(!ui_checked){
      ...
      if(ui_shadow){
        draw_set_alpha(ui_shadow_alpha);
        draw_circle_colour(ui_x + (ui_size * 0.5), ui_y + (ui_size * 0.5), (ui_size * 0.5) + 2, ui_black, ui_black, false);
        draw_circle_colour(ui_x + (ui_size * 0.5), ui_y + (ui_size * 0.5) + 1, (ui_size * 0.5) + 1, ui_black, ui_black, false);
        draw_set_alpha(1);
      }
      draw_circle_colour(ui_x + (ui_size * 0.5), ui_y + (ui_size * 0.5), (ui_size * 0.5) + 1, ui_foreground_colour, ui_foreground_colour, false);
      draw_circle_colour(ui_x + (ui_size * 0.5), ui_y + (ui_size * 0.5), (ui_size * 0.5) - 1, ui_inner_colour, ui_inner_colour, false);
      if(ui_checked or ui_alpha > 0){
        draw_set_alpha(ui_alpha);
        draw_circle_colour(ui_x + (ui_size * 0.5), ui_y + (ui_size * 0.5), ((ui_size * 0.5) + 1) * ui_alpha, ui_background_colour, ui_background_colour, false);
        draw_set_alpha(1);
      }
      draw_set_halign(fa_left);
      draw_set_valign(fa_middle);
      ...
      draw_circle_colour(ui_x + (ui_size * 0.5), ui_y + (ui_size * 0.5), (ui_size * 0.5) + 1, ui_colour_lighter_ext(ui_grey, 2), ui_colour_lighter_ext(ui_grey, 2), false);
      if(!ui_checked){
        draw_circle_colour(ui_x + (ui_size * 0.5), ui_y + (ui_size * 0.5), (ui_size * 0.5) - 1, ui_inner_colour, ui_inner_colour, false);
      } 
      draw_set_halign(fa_left);
    ...
    if(ui_focus){
      if(ds_exists(ui_global_config, ds_type_map)){
        if(ds_map_find_value(ui_global_config, "debug_mode")){
          draw_set_alpha(0.25);
          draw_rectangle_colour(ui_x - 1, ui_y - 1, ui_x + ui_size + ui_padding_horizontal + string_width(ui_label) + 2, ui_y + ui_size + 3, ui_blue_grey, ui_blue_grey, ui_blue_grey, ui_blue_grey, true);
          draw_set_alpha(1);
        }
      }
    }
          ...
          if(device_mouse_check_button_pressed(0, mb_left) or (ui_focus && keyboard_action && keyboard_check_pressed(vk_enter))){
            ...
            for(var ui_i = 0; ui_i < ds_list_size(ui_global_controls); ui_i += 1){
              ...
              if(ds_exists(control, ds_type_map)){
                if(control != argument[0]){
                  ui_active = false;
                  ds_map_replace(control, "ui_active", ui_active);
                }
              }
            }
            ui_focus = true;
...
if(argument_count == 2){
  if(ds_exists(argument[0], ds_type_map)){
    if(ds_map_exists(argument[0], "ui_range")){
      ds_map_replace(argument[0], "ui_range", argument[1]);
      return true;
    }
    else{
      ui_debug_error(103);
...
if(argument_count == 1){
  if(ds_exists(argument[0], ds_type_map)){
    ...
    var ui_height = ds_map_find_value(argument[0], "ui_height");
    var ui_clicked = ds_map_find_value(argument[0], "ui_clicked");
    var ui_minval = ds_map_find_value(argument[0], "ui_minval");
    var ui_maxval = ds_map_find_value(argument[0], "ui_maxval");
    var ui_value = ds_map_find_value(argument[0], "ui_value");
    ...
    if(ui_enable){
      ...
      if(device_mouse_check_button(0, mb_left) && ui_clicked){
        ui_value = clamp(round((ui_mouse_x - (ui_x + ui_padding_horizontal)) / ui_width * ui_rangesize), ui_minval, ui_maxval);
...
if(argument_count == 1){
  if(ds_exists(argument[0], ds_type_map)){
    ...
    var ui_clicked = ds_map_find_value(argument[0], "ui_clicked");
    var ui_items = ds_map_find_value(argument[0], "ui_items");
    var ui_item_width = ui_width / ds_list_size(ui_items);
    var ui_selected = ds_map_find_value(argument[0], "ui_selected");
    ...
    if(ui_enable){
      ...
      if(ui_active && ((ui_mouse_x > ui_x && ui_mouse_x < ui_x + ui_width && ui_mouse_y > ui_y && ui_mouse_y < ui_y + ui_height))){        
        if(device_mouse_check_button_pressed(0, mb_left)){
      ...
      if(surface_exists(ui_surface)){
        if(ui_shadow){
          draw_set_alpha(0.05);
          draw_rectangle_colour(ui_x, ui_y + ui_height + 2, ui_x + ui_width + 2, ui_y + ui_content_height + 2, ui_black, ui_black, ui_black, ui_black, true);
          draw_rectangle_colour(ui_x + 1, ui_y + ui_height - 1, ui_x + ui_width + 1, ui_y + ui_content_height + 1, ui_black, ui_black, ui_black, ui_black, true);
          draw_set_alpha(1);
        }
        draw_surface(ui_surface, ui_x, ui_y + ui_height);
      }
      if(ui_shadow){
        draw_set_alpha(0.015);
        draw_roundrect_colour_ext(ui_x - 4, ui_y - 4, ui_x + ui_width + 4, ui_y + ui_height + 4, 4, 4, ui_black, ui_black, false);
        draw_roundrect_colour_ext(ui_x - 3, ui_y - 3, ui_x + ui_width + 3, ui_y + ui_height + 3, 4, 4, ui_black, ui_black, false);
        draw_roundrect_colour_ext(ui_x - 2, ui_y - 2, ui_x + ui_width + 2, ui_y + ui_height + 2, 4, 4, ui_black, ui_black, false);
        draw_roundrect_colour_ext(ui_x - 1, ui_y - 1, ui_x + ui_width + 1, ui_y + ui_height + 2, 4, 4, ui_black, ui_black, false);
        draw_roundrect_colour_ext(ui_x - 1, ui_y - 1, ui_x + ui_width + 1, ui_y + ui_height + 1, 4, 4, ui_black, ui_black, false);
        draw_set_alpha(0.2);
        draw_line_width_colour(ui_x, ui_y + ui_height + 2, ui_x + ui_width, ui_y + ui_height + 2, 1, ui_black, ui_black);
        draw_line_width_colour(ui_x, ui_y + ui_height + 1, ui_x + ui_width, ui_y + ui_height + 1, 1, ui_black, ui_black);
        draw_set_alpha(1);
      }
      draw_roundrect_colour_ext(ui_x, ui_y, ui_x + ui_width , ui_y + ui_height, 4, 4, ui_background_colour, ui_background_colour, false);
      if(ui_wave){
        if(ui_effect){
          if(ui_wave_size < 1){
            ui_wave_size += ui_effect_speed;
      ...
      draw_roundrect_colour_ext(ui_x, ui_y, ui_x + ui_width , ui_y + ui_height, 4, 4, ui_colour_lighter(ui_grey), ui_colour_lighter(ui_grey), false);
    ...
    if(ui_focus){
      if(ds_exists(ui_global_config, ds_type_map)){
        if(ds_map_find_value(ui_global_config, "debug_mode")){
          draw_set_alpha(0.25);
          draw_rectangle_colour(ui_x - 1, ui_y - 1, ui_x + ui_width + 2, ui_y + ui_content_height + 2, ui_blue_grey, ui_blue_grey, ui_blue_grey, ui_blue_grey, true);
          draw_set_alpha(1);
        }
      }
    }
